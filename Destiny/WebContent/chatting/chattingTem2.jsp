...
$bodyBack: rgb(51, 102, 153)
body
    position: relative
    overflow-x: hidden
    background-color: darken($bodyBack, 5%)
.info-panel * 
...
.message-input-bar
    ...
    .media-expand-arrow
        ...
        .media-expand-arrow-line
            ...
            padding: 0px
            transition: all 0.1s ease-in-out
        .media-expand-arrow-line-1
            transform: rotate(50deg)
            left: 39%
            top: 16%
            height: 25%
        .media-expand-arrow-line-2
            transform: rotate(-50deg)
            left: 52%
            height: 25%
            top: 16%
        .media-expand-arrow-line-3
            left: 45.3%
            top: 20.5%
            height: 46%
        &:hover
